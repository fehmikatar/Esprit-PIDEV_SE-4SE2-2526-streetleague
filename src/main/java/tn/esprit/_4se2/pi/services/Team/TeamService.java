...
import tn.esprit._4se2.pi.dto.ChangeMemberRoleRequest;
import tn.esprit._4se2.pi.dto.JoinRequestRequest;
import tn.esprit._4se2.pi.dto.JoinRequestResponse;
import tn.esprit._4se2.pi.dto.TeamCurrentUserContext;
...
public class TeamService implements ITeamService {
    ...
    @Override
    @Transactional
    public void handleJoinRequest(Long teamId, Long requestId, tn.esprit._4se2.pi.dto.JoinRequestActionRequest action, Long authenticatedUserId) {
        findTeamOrThrow(teamId);
    ...
    private String resolveSportCategoryOrThrow(String sportName) {
        ...
        return categoryRepository.findByNomIgnoreCase(sportName.trim())
            ...
            Category category = categoryRepository.findByNomIgnoreCase(sportName)
                .orElseGet(() -> {
                    Category c = Category.builder().nom(sportName.trim()).createdAt(LocalDateTime.now()).build();
