...
public class MatchDTOs {
    ...
    public static class MatchResponseDTO {
        ...
        public MatchResponseDTO(Long id, Long competitionId, String competitionName, Long homeTeamId, String homeTeamName, Long awayTeamId, String awayTeamName, LocalDateTime scheduledAt, String venue, MatchStatus status, Integer homeScore, Integer awayScore) {
            this.id = id;
    ...
    // Update Score DTO
    public static class MatchScoreUpdateDTO {
